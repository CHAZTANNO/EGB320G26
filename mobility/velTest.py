...
def SetTargetVelocities(x_dot, theta_dot):
    ...
    left_motor_output = min(max(abs(left_motor_rpm / max_motor_rpm * 100), 0), max_motor_output)
    right_motor_output = min(max(abs(right_motor_rpm / max_motor_rpm * 100), 0), max_motor_output)
