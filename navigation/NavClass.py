...
class NavClass:
    ...
    def potential_fields(self):
        ...
        repulsive_gain = 0.5   # Gain for the repulsive force (away from obstacles, shelves, and walls)
        safe_distance = 1    # Distance at which repulsive force starts to take effect
