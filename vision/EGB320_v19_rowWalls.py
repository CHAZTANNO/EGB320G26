...
class visionSystem:
    def __init__(self):
        ...
        self.blackThreshold = [16, 108, 0, 54, 16, 110]
        self.squareThreshold = [15, 44, 55, 131, 59, 118]
        self.wallThreshold = [25, 49, 0, 74, 207, 255]
        self.wallThresholdInRow = [19, 46, 0, 58, 169, 255]
